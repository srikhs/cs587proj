...
func (d *Decoder) myType() (v *MyType, error os.Error){
...
func (d *Decoder) myTypeInternal() (v *MyType, error os.Error){
...
func (t *MyType) Write(fd syscall.Fd) (syscall.Status) {
